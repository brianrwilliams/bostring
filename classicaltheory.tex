...
\owen{I'm not sure I like this description, although it's accurate. Maybe something more concrete like ``for each $\alpha$, we get a second-order differential operator $D_n(\alpha)$.'' I also removed the $n$-fold appearance of $\alpha$.}
...
whose exact form is irrelevant to us. \owen{Is it clear why $S'$ doesn't matter? For instance, does it obviously vanish in the infinite volume limit?}

...
\[
\Def_{\rm string}(\CC,V)^\CC \simeq \cred(\wone, \Sym^{>0}(V^\vee[z^\vee] \oplus V[z^\vee] \d z^\vee \oplus )) 
\]
deformation complex of translation-invariant local functionals for the holomorphic string 
\end{lem}

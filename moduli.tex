...
\ben
\left(\Oloc\left(\Omega^{0,*}(\Sigma, T^{1,0})[1] \oplus \Omega^{0,*}(\Sigma, V)\right), \{S, -\}\right) .
\een
Suppose $\Sigma = $....
...
The weight $\CC^\times_{\rm cot}$-weight zero sub Lie algebra of the Lie algebra (\ref{jet lie}) is simply $W_1 \ltimes V [[z]] [-1]$. 
Thus, we have reduced the calculation of the weight zero piece of the local deformation complex to calculating the Chevalley-Eilenberg complex of this Lie algebra:
\ben
\clie^*\left({\rm W}_1 ; \Sym^{\geq 1} (V [[z]])^\vee \right) .
\een

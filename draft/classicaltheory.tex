...
For a physical description that is close to the bosonic string theory we consider we recommend the classical treatment in \cite{polchinski}.
For a more modern exposition see D'Hoker's notes in Volume II of \cite{IAScourse}.

...
\owen{Why do we need the trivializations? I'm a bit confused about this point now.}
...
\owen{We can remove the following paragraph if you think it's confusing.}
...
\owen{This is probably too pedantic to worry about, but $\d^\q$ {\em a priori} requires compact support \dots}
...
\owen{Do you mean they can overlap but not be a proper subset? Or do you want them disjoint? Or their closures disjoint?}

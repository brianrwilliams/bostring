...
on arbitrary $\Sigma$, 
the deformation complex is a sheaf of cochain complexes quasi-isomorphic to $\CC_\Sigma[-1]$,
the constant sheaf  concentrated in degree~$1$. 
\owen{Ref seems to want a little more explanation of this assertion. I'm not sure how much we should say, but I think it might be worthwhile to comment explicitly that this cocycle is the usual Gelfand-Fuks jobby, and maybe even write it!}

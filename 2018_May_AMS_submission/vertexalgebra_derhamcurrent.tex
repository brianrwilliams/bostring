...
In more formal terms, consider the de Rham complex of our $D$-module
\ben
...
Consider now the compactly supported, distributional completion 
\[
\overline{\Omega}^*_c(\CC , \sO(J E_{\rm string})),
\]
consisting of compactly supported de Rham currents with values in Lagrangians.
It determines, of course, a cosheaf of cochain complexes.
Moreover, \owen{I think this is not a necessary direction right now.}

...
We remark that  every element of $\Gr \cV_{\rm string}$ can be realized by applying descent to the pointlike operators and then evaluating at the origin.\owen{OK?}

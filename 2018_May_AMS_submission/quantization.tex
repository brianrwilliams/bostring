...
\owen{Do we really want to include this comment?}
It would be interesting to compare our method for renormalization of the bosonic string to Witten's ``$i\epsilon$'' procedure for the perturbative string in~\cite{WittenFeynman}.

...
\brian{I wrote this argument pretty quickly and know it needs to be fixed. Just wanted to get it down so we can discuss tomorrow. For instance, I know we need to be careful of using the completion for Obs.}
...
To show that this cohomology agrees with the cohomology of the free theory, \owen{Here I inserted a comma} we consider another filtration on the classical observables $\Obs^{\cl}(\Sigma)$.
...
\owen{I'm confused by the parentheses in the left term}
\[
...
Because of the cohomological shift, this cocycle is determined by a constant function on $\Sigma$.

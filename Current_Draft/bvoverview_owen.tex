...
<<<<<<< HEAD
%\owen{I don't think this is a great first sentence. It might be good to have a slightly nicer run-up.}
=======
\owen{I don't think this is a great first sentence. It might be good to have a slightly nicer run-up.}
\brian{Not crazy about what I did, but what do you think?}

Bosonic string theory is described by the path integral of the of the Polyakov action and is typically analyzed using well-established techniques in conformal field theory.
Motivated by the Wilsonian approach to effective field theory, a mathematical formulation of the path integral in perturbative quantum field theory has been constructed by Costello in \cite{CosBook}. 
It is a natural problem to construct the bosonic string via these methods. 
>>>>>>> 3e3a2a2c217ab0432ac4460cb9424128ef49c721

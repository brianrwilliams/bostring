...
\end{array}
\]
\owen{Eugene pointed out that columns 0 and 1 aren't lined up, which is annoying once you see it}
...
or~\cite{Scherk}. 
\owen{Did I pick the right chapter of GSW?}
\end{rmk}
...
\ee
\owen{Eugene commented "explain this as $\langle \phi \sum \log(\phi^n)\rangle$ (or something). I recall he also found this discussion a bit dense.}
\brian{Not sure what he means. I've tried to clarify the discussion.}
\owen{I like it better now!}
...
\owen{I removed the $\int_\Sigma$, which did not make sense to me.}
\ben
...
\owen{Eugene writes "why?" perhaps to mean why do we do this?}

...
\owen{Eugene: I would switch 5.1 and 5.2 to indicate you're still working in the BV formalism and that the formalism reproduces the VOA}

\owen{I implemented his suggestion and made some edits. Tell me what you think.}
...
\begin{itemize}
\item For any chiral interaction~$I$, the action $S_{\rm free} + I$ needs no counterterms \owen{Eugene: in what sense? are all diagrams finite?}, 
and yields a renormalized interaction~$\{S [L]\}$.
\owen{Perhaps we can compare to Prop \ref{prop: no counterterms}?}
...
\owen{Eugene found this a little hard to follow. I tried to change it a little.}
...
\owen{I'm not wild about using $\star$ for the factorization product, since it's not a single binary product. Also recall my discomfort with observables on closed sets like $C$.} 

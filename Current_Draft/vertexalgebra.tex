...
\owen{Eugene: I thought it was a quantization of the full interacting system. (Need to rephrase to remind that we're using the modification by $I$, in Si's style.}
...
View the vector field $\frac{\d}{\d z}$ as a constant $c$-field. 
...
\owen{Eugene found this a little hard to follow.}
